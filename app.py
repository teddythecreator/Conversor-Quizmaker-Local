...
# Descripción: App web con Streamlit para convertir documentos .docx con preguntas tipo test al formato XLSX compatible con Quiz Maker
...
def construir_estructura_xlsx(preguntas):
    ...
    for idx, item in enumerate(preguntas):
        ...
        fila = {
            "id": "",
            "category": "",  # dejar en blanco, lo asignas manualmente
